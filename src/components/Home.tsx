    ...
    <section id="home" className="flex flex-col">
      <div className="flex items-start px-6 pt-4 pb-16 sm:px-20 md:px-16 md:pt-6 lg:px-24 lg:pt-8 xl:px-32">
        ...
        <div className="flex w-full flex-col items-center text-center md:w-2/3">
          <h1 className="font-symphony text-5xl text-foreground md:text-6xl">
            <span className="font-symphony text-7xl">Aaliyah</span>
            <span className="ml-10 font-serif text-6xl">Pirani</span>
          </h1>
